...
<main>
    ...
    <div class="modal" id="modal-2">
        <div class="modal__content">
          ...
          <form id="form_gallery_change_breed" action = "" method="post">
            <div class = "form">
                <p>Описание</p>
                <div class ="input-form">
                <textarea id="gallery_breed_change_desc" name="description" cols="60" rows="5" ></textarea> </div> <br> <br>
    ...
    <h1>Описание собаки в галерее</h1>
    <table class="container">
        ...
        <tbody id="gallery_table_dogDesc_body">
    ...
    <div class="modal" id="modal_1">
        <div class="modal__content">
          ...
          <!-- Контент модального окна -->
          <h1>Добавить</h1>
          <form id="form_gallery_add_img" action = "" method="post" enctype="multipart/form-data">
            <div class = "form">
                <p>Имя собаки</p>
                <div class ="input-form">
                    <select id="sel_add_dogs" class="select-css"> 
                ...
                <div class ="input-form">
                        <div class="input__wrapper">
                            <input name="imgDog" type="file" id="input__file_img_add" class="input input__file" multiple>
                            <label for="input__file_img_add" class="input__file-button">
    ...
    <div class="modal" id="modal-3">
        <div class="modal__content">
          ...
          <form id="form_imgDog_change" action = "" method="post" enctype="multipart/form-data">
            <div class = "form">
                <p>Изображение </p>
                <div class ="input-form">
                        <div class="input__wrapper">
                            <input name="img" type="file" id="input__file_chg_imgDog" class="input input__file" multiple>
                            <label for="input__file_chg_imgDog" class="input__file-button">
                                <span class="input__file-icon-wrapper">
                                    <svg class="upload-file__icon"  viewBox="0 0 512 512">
                                        <path d="M286 384h-80c-14.2 1-23-10.7-24-24V192h-87.7c-17.8 0-26.7-21.5-14.1-34.1L242.3 5.7c7.5-7.5 19.8-7.5 27.3 0l152.2 152.2c11.6 11.6 3.7 33.1-13.1 34.1H320v168c0 13.3-10.7 24-24 24zm216-8v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-23-23V366c0-13.3 10.7-24 24-24h136v8c0 31 24.3 56 56 56h80c30.9 0 55-26.1 57-55v-8h135c13.3 0 24 10.6 24 24zm-124 88c0-11-9-20-19-20s-19 9-20 20 9 19 20 20 21-9 20-20zm64 0c0-12-9-20-20-20s-20 9-19 20 9 20 20 20 21-9 20-20z"></path>
                                    </svg>
    ...
    <div class="modal-2" id="modal_5">
        ...
        <div class="modal_content-2">
            <h1 class="modal__title">Удаление записи</h1>
            <p class="modal__description">Вы действительно хотите удалить запись?</p>
            <button id="btn-img-delete-yes">Да</button>
            <button id="btn-img-delete-no">Нет</button>
        </div>
        </div>
    </div>
    <h1>Галерея</h1>
    <table class="container">
        ...
        <tbody id="gallery_table_imgs_dogs">
            <!-- Цикл вывода информации из БД -->              
        </tbody>
    </table>
</main>
