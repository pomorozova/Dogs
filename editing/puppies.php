...
<main>
    ...
    <div class="modal" id="modal_1">
        <div class="modal__content">
          ...
          <h1>Добавить</h1>
          <form id="form_pup_add" action = "" method="post" enctype="multipart/form-data">
              <div class = "form">
                <p>Мать</p>
                <div class ="input-form">
                <textarea id="tb_add_desc_mom" name="mother" cols="60" rows="5" ></textarea> </div>
      
                  <p>Отец</p>
                  <div class ="input-form">
                  <textarea id="tb_add_desc_fat" name="father" cols="60" rows="5" ></textarea> </div>
    ...
    <div class="modal" id="modal-2">
        <div class="modal__content">
          ...
          <h1>Изменить</h1>
          <form id="form_pupInfo_change" action = "" method="post" enctype="multipart/form-data">
              <div class = "form">
                <p>Мать</p>
                <div class ="input-form">
                <textarea id="pup_desc_mom" name="mother" cols="60" rows="5" ></textarea> </div>
      
                  <p>Отец</p>
                  <div class ="input-form">
                  <textarea id="pup_desc_fat" name="father" cols="60" rows="5" ></textarea> </div>

                  <p>Описание щенков</p>
                  <div class ="input-form">
                  <input id="pup_desc_pup" type="text" name="description-puppies"></div>
    ...
    <div class="modal-2" id="modal-4">
        ...
        <div class="modal_content-2">
            ...
            <button id="btn_del_pup_yes" class="btn-delete-yes">Да</button>
            <button id="btn_del_pup_no" class="btn-delete-no">Нет</button>
        </div>
        </div>
    </div>
