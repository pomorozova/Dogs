...
<div class="modal" id="modal-3">
    <div class="modal__content">
      ...
      <!-- Контент модального окна -->
        <h1>Изменить</h1>
        <form id="form_breed_change" action = "" method="post">
            <div class = "form">
                <p>Заголовок</p>
                <div class ="input-form">
                <input id="inpDescBreed_title" type="text" name="heading"></div>
                <p>Основной текст</p>
                <div class ="input-form">
                <textarea id="inpDescBreed_desc" name="description" cols="60" rows="5" ></textarea> </div> <br> <br>
    ...
    <div class="modal-2" id="modal-4">
        ...
        <div class="modal_content-2">
            ...
            <button id="btn_del_breedInfo_yes" class="btn-delete-yes">Да</button>
            <button id="btn_del_breedInfo_no" class="btn-delete-no">Нет</button>
        </div>
        </div>
    </div>
...
<table class="container">
    ...
    <tbody id="table_ourdog_desc_body">
    ...
    <h1>Добавить</h1>
    <div class="btn-news"> 
        <div class="btn-news-1">
            <button type="submit" id="callback_button" class="header__button">Добавить</button>
        </div>
    </div>
    ...
    <div class="modal" id="modal_1">
        <div class="modal__content">
          ...
          <h1>Добавить</h1>
          <form id="form_dog_add" action = "" method="post" enctype="multipart/form-data">
              <div class = "form">
                  <p>Имя собаки</p>
                  <div class ="input-form">
                  <input id="dog_breed_add" type="text" name="name_dog"></div>

                <p>Порода</p>
                <div class ="input-form">
                    <select id="dog_breeds_add" class="select-css"> 
                        <option disabled>Выберете собаку</option>
                    </select>
                </div>
                  <p>Изображение</p>
                  <div class ="input-form">
                          <div class="input__wrapper">
                              <input name="img" type="file" id="input__file_dog_img" class="input input__file" multiple>
                              <label for="input__file_dog_img" class="input__file-button">
    ...
    <div class="modal" id="modal-2">
        <div class="modal__content">
          ...
          <h1>Изменить</h1>
          <form id="form_dogs_change" action = "" method="post" enctype="multipart/form-data">
                <div class = "form">
                    <p>Порода</p>
                    <div class ="input-form">
                        <select id="dog_breeds_change" class="select-css"> 
                            <option disabled>Выберете собаку</option>
                        </select>
                    </div>
                    <p>Имя собаки</p>
                    <div class ="input-form">
                    <input id="inpNameDog_chg" type="text" name="name_dog"></div>
    ...
    <div class="modal-2" id="modal_5">
        ...
        <div class="modal_content-2">
            <h1 class="modal__title">Удаление записи</h1>
            <p class="modal__description">Вы действительно хотите удалить запись?</p>
            <button id="btn_del_dog_yes" class="btn-delete-yes">Да</button>
            <button id="btn_del_dog_no" class="btn-delete-no">Нет</button>
        </div>
        </div>
    </div>
    <h1>Наши собаки</h1>
    <table class="container">
        <thead>
            <tr>
                <th><h1>№</h1></th>
                <th><h1>Порода</h1></th>
                <th><h1>Имя собаки</h1></th>
                <th><h1>Фото</h1></th>
                <th><h1>Изменение</h1></th>
                <th><h1>Удаление</h1></th>
            </tr>   
        </thead>
        <tbody id="table_ourdog_breed_body">
            <!-- Цикл вывода информации из БД -->
        </tbody>
    </table>
</main>
