...
if($act["part"] == "main"){
    ...
    switch($act["adm"]){
        ...
        case "adm_puppies_change": adm_chg_puppies($conn, $act["id"],$act["data"]);break;
        case "adm_puppies_del": adm_del_puppies($conn, $act["id"]);break;
        case "adm_puppies_add": adm_add_puppies($conn, $act["data"]);break;
    }
}
